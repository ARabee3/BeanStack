...
$base = str_repeat('../', substr_count(ltrim($_SERVER['PHP_SELF'], '/'), '/') - 1);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        ...
        /* Topbar */
        .topbar { background: #fff; border-bottom: 1px solid #e9ecef; height: 56px; }
        .topbar .brand { font-weight: 700; font-size: 1.1rem; letter-spacing: -.01em; color: #212529; }
        .topbar .brand span { color: #d97706; }
        ...
        .price-badge { font-size: .7rem; font-weight: 700; }

        /* Latest order sidebar */
        #orderPanel { min-width: 280px; max-width: 280px; }
        ...
        /* Pagination */
        .page-link { color: #d97706; }
        .page-item.active .page-link { background: #d97706; border-color: #d97706; color: #fff; }

        /* Status badges */
        .badge-processing { background: #fff3cd; color: #664d03; }
        ...
        .badge-unavailable{ background: #f8d7da; color: #58151c; }

        /* Form validation helpers */
        .form-control:focus, .form-select:focus { border-color: #d97706; box-shadow: 0 0 0 .2rem rgba(217,119,6,.2); }

        /* Responsive: collapse sidebar on small screens */
        @media (max-width: 767.98px) {
            #sidebar { display: none !important; }
            #orderPanel { min-width: 100%; max-width: 100%; }
        }
    </style>
</head>
<body>
