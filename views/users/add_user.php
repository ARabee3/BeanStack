...
<nav aria-label="breadcrumb" class="mb-3">
    <ol class="breadcrumb small">
        <li class="breadcrumb-item">
            <a href="all_users.php" class="text-warning text-decoration-none">Users</a>
        </li>
...
<div class="alert alert-success d-flex align-items-center gap-2">
    ...
    <a href="all_users.php" class="ms-auto btn btn-sm btn-success">← Back to Users</a>
</div>
<?php endif; ?>
    ...
    <div class="p-4">
        <form method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
            ...
            <div class="d-flex gap-3 align-items-center">
                ...
                <a href="all_users.php" class="btn btn-link text-muted text-decoration-none ms-auto">
                    Cancel
                </a>
            </div>
